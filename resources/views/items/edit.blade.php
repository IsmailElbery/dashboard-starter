                    ...
                    <form action="{{ route('items.update', $item) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                       id="color" name="color" value="{{ old('color', $item->color ?? '#563d7c') }}">
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('manufacturing_date') is-invalid @enderror"
                                       ...
                                       value="{{ old('manufacturing_date', $item->manufacturing_date?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('expiry_date') is-invalid @enderror"
                                       ...
                                       value="{{ old('expiry_date', $item->expiry_date?->format('Y-m-d\TH:i')) }}">
                                @error('expiry_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="url" class="form-control @error('url') is-invalid @enderror"
                                       id="url" name="url" value="{{ old('url', $item->url) }}" placeholder="https://example.com">
                                @error('url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_featured"
                                       name="is_featured" {{ old('is_featured', $item->is_featured) ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_available"
                                       name="is_available" {{ old('is_available', $item->is_available) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if($item->document)
                                    <div class="mb-2">
                                        <a href="{{ asset('storage/' . $item->document) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                ...
                                <small class="text-muted">Max size: 2MB. Formats: PDF, DOC, DOCX. Leave empty to keep current document.</small>
                                @error('document')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
